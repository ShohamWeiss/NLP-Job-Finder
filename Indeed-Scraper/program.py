...
if __name__ == "__main__":
    ...
    locations = ["Austin, TX", "Dallas, TX", "San Francisco, CA", "San Diego, CA", "Chicago, IL", "Seattle, WA"]
    ...
    indeedScraper.ScrapeCombos(titles, locations, experience_levels, education_level, job_types, "data.csv")